package eleven._.com.eleven.views;

import eleven._.com.eleven.model.EMatch;
import com.eleven.views.util.JsfUtil;
import com.eleven.views.util.JsfUtil.PersistAction;
import eleven._.com.eleven.controller.EMatchFacade;
...
/*** added by dEMatchController
 */
@Named("eMatchController")
@ViewScoped
public class EMatchController implements Serializable {
	@EJB
	private com.eleven.controller.EMatchFacade ejbFacade;
	private List<EMatch> items = null;
	private EMatch selected;
	public EMatchController() {
	}
	...
	public void create() {
		persist(PersistAction.CREATE,
			ResourceBundle.getBundle("/Bundle").getString("EMatchCreated"));
	...
	public void update() {
		persist(PersistAction.UPDATE,
			ResourceBundle.getBundle("/Bundle").getString("EMatchUpdated"));
	}
	public void destroy() {
		persist(PersistAction.DELETE,
			ResourceBundle.getBundle("/Bundle").getString("EMatchDeleted"));
		if(! JsfUtil.isValidationFailed()) {
			selected = null;
			items = null;
		}
	}
	public List<EMatch> getItems() {
		if(items == null) {
	...
	public static class EMatchControllerConverter implements Converter {
		...
		public Object getAsObject(FacesContext facesContext, UIComponent component,
			...
			EMatchController controller = ( EMatchController )
			facesContext.getApplication().getELResolver().getValue(facesContext.getELContext(),
				null, "eMatchController");
			...
			if(object instanceof EMatch) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
					"object {0} is of type {1}; expected type: {2}", new Object [] {
						object, object.getClass().getName(), EMatch.class.getName()
					});
				return null;
			}
		}
