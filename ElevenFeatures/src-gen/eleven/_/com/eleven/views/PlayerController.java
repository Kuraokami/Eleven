...
import eleven._.com.eleven.controller.PlayerFacade;
...
/*** added by dPlayerController
 */
@Named("playerController")
@SessionScoped
public class PlayerController implements Serializable {
	@EJB
	private com.eleven.controller.PlayerFacade ejbFacade;
	...
	public void create() {
		persist(PersistAction.CREATE,
			ResourceBundle.getBundle("/Bundle").getString("PlayerCreated"));
	...
	public void update() {
		persist(PersistAction.UPDATE,
			ResourceBundle.getBundle("/Bundle").getString("PlayerUpdated"));
	}
	public void destroy() {
		persist(PersistAction.DELETE,
			ResourceBundle.getBundle("/Bundle").getString("PlayerDeleted"));
		if(! JsfUtil.isValidationFailed()) {
			selected = null;
			items = null;
		}
			...
			if(object instanceof Player) {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
					"object {0} is of type {1}; expected type: {2}", new Object [] {
						object, object.getClass().getName(), Player.class.getName()
					});
				return null;
			}
		}
